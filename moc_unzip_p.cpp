...
#include "../BaroScript/GLOBAL/ZIP/unzip_p.h"
...
static const char qt_meta_stringdata_UnzipPrivate[] = {
    "UnzipPrivate\0deviceDestroyed(QObject*)\0"
    "\0"
};
...
const QMetaObjectExtraData UnzipPrivate::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject UnzipPrivate::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_UnzipPrivate,
      qt_meta_data_UnzipPrivate, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &UnzipPrivate::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UnzipPrivate))
