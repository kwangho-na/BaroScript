...
#include "../BaroScript/WIDGET/TreeModel.h"
...
static const uint qt_meta_data_TreeDelegate[] = {
...
static const char qt_meta_stringdata_TreeDelegate[] = {
    "TreeDelegate\0"
};

void TreeDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData TreeDelegate::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TreeDelegate::staticMetaObject = {
    { &QStyledItemDelegate::staticMetaObject, qt_meta_stringdata_TreeDelegate,
      qt_meta_data_TreeDelegate, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &TreeDelegate::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION

const QMetaObject *TreeDelegate::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->metaObject : &staticMetaObject;
}

void *TreeDelegate::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TreeDelegate))
        return static_cast<void*>(const_cast< TreeDelegate*>(this));
    return QStyledItemDelegate::qt_metacast(_clname);
}

int TreeDelegate::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
